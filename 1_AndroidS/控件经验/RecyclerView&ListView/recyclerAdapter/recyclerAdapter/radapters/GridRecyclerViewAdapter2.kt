 ...
 */
class GridRecyclerViewAdapter2 : RecyclerView.Adapter<ViewKeeper> {
...
//    }
     ...
     * @param 列数
     */
    constructor(ctx: Context, resLayout: Int, callBackFunc: GridRecyclerViewAdapter2.CallBackFunc, culNums: Int, view: RecyclerView) {
        this.ctx = ctx;
