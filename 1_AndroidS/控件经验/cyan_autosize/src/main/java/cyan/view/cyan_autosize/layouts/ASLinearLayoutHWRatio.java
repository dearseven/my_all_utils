 ...
 */
public class ASLinearLayoutHWRatio extends LinearLayout {
    private final String T = "auto-size";
    float w = -1f;
    float h = -1f;
    private Context ctx = null;

    public ASLinearLayoutHWRatio(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ASLinearLayoutHWRatio(Context context) {
        super(context);
    }

    public ASLinearLayoutHWRatio(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
