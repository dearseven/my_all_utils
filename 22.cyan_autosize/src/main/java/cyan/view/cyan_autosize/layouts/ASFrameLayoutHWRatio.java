 ...
 */
public class ASFrameLayoutHWRatio extends FrameLayout {
    private final String T = "auto-size";
    float w = -1f;
    float h = -1f;
    private Context ctx = null;

    public ASFrameLayoutHWRatio(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ASFrameLayoutHWRatio(Context context) {
        super(context);
    }

    public ASFrameLayoutHWRatio(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
