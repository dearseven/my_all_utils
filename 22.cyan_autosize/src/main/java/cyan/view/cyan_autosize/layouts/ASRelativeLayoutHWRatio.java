 ...
 */
public class ASRelativeLayoutHWRatio extends RelativeLayout {
    private final String T = "auto-size";
    float w = -1f;
    float h = -1f;
    private Context ctx = null;

    public ASRelativeLayoutHWRatio(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ASRelativeLayoutHWRatio(Context context) {
        super(context);
    }

    public ASRelativeLayoutHWRatio(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
