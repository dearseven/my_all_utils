...
public class ASFrameLayout extends FrameLayout {
    ...
    public ASFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ASFrameLayout(Context context) {
        super(context);
    }

    public ASFrameLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
