 ...
 */
public class ASImageButtonHWRatio extends android.support.v7.widget.AppCompatImageButton {
    private final String T = "auto-size";
    float w = -1f;
    float h = -1f;
    private Context ctx = null;

    public ASImageButtonHWRatio(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ASImageButtonHWRatio(Context context) {
        super(context);
    }

    public ASImageButtonHWRatio(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
