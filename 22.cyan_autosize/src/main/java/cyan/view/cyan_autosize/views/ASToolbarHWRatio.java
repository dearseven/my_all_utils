 ...
 */
public class ASToolbarHWRatio extends Toolbar {

    public ASToolbarHWRatio(Context context) {
        super(context);
    }

    public ASToolbarHWRatio(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public ASToolbarHWRatio(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
