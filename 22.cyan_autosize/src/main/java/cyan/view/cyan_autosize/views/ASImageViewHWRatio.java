 ...
 */
public class ASImageViewHWRatio extends android.support.v7.widget.AppCompatImageView {
    private final String T = "auto-size";
    float w = -1f;
    float h = -1f;
    private Context ctx = null;

    public ASImageViewHWRatio(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ASImageViewHWRatio(Context context) {
        super(context);
    }

    public ASImageViewHWRatio(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
