 ...
 */
public class ASImageButton extends android.support.v7.widget.AppCompatImageButton {
    private final String T = "auto-size";
    float w = -1f;
    float h = -1f;
    private Context ctx = null;

    public ASImageButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ASImageButton(Context context) {
        super(context);
    }

    public ASImageButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
