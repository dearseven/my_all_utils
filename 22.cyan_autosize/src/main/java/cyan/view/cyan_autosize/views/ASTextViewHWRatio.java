 ...
 */
public class ASTextViewHWRatio extends android.support.v7.widget.AppCompatTextView {
    private final String T = "auto-size";
    float w = -1f;
    float h = -1f;
    private Context ctx = null;

    public ASTextViewHWRatio(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ASTextViewHWRatio(Context context) {
        super(context);
    }

    public ASTextViewHWRatio(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
