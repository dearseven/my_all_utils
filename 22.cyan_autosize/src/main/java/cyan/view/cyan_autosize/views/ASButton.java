 ...
 */
public class ASButton extends android.support.v7.widget.AppCompatButton {
    private final String T = "auto-size";
    float w = -1f;
    float h = -1f;
    private Context ctx = null;

    public ASButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public ASButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
