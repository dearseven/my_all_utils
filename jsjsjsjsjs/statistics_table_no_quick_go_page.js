...
(function() {
	...
	CyanStatisticsTable.prototype.makeTable = function(columnType, data,
		...
		// 生成直接跳转区
		/*
		 * html += "<div style='clear:both;'>跳转到第<input typy='text'
		 * style='display:inline-block;
		 * width:2em;'id='cyan_staticsitc_table_go_page_input'/>页，总页数<span>" +
		 * maxpage + "</span><input type='button'
		 * style='display:inline-block;'
		 * onclick='$cst.cyanStaticsitcTableGoPage(3,-1);' value='跳转' ></div>";
		 */
		ctn.innerHTML = html;
