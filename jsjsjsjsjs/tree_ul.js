...
CyanTreeUI.prototype.setNeedAddBlank = function(need) {
 ...
 */
CyanTreeUI.prototype.init = function(_beanOrg, containerId) {
	this.beanOrgs = _beanOrg;
	this.containerId = containerId;
}
CyanTreeUI.prototype.testInit = function(containerId) {
	this.containerId = containerId;
 ...
 */
CyanTreeUI.prototype.drawTree = function(idPrex) {
	this.prex = idPrex;
	// 获取容器
 ...
 * 设置回调
 */
CyanTreeUI.prototype.setClickCallback = function(_callback) {
